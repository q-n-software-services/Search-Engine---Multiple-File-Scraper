...
class Window(QWidget):
    ...
    def scan_excel(self):
        ...
        for file in excel_links:
            ...
            try:
                ...
                word_list = self.keyword.strip().split()
                ...
                for record in range(records):
                    for column in keys:
                        ...
                        for word in word_list:
                            ...
                            if word in str(all_rows[record][column]).lower():
                                EFound = True
                                # print(i)
                                # print(record, column)
                                # print(all_rows[record][column])
                                i += 1
                                ...
                                if printed == False:
                                    if name_printed == False:
                                        if EFound:
                                            ...
                                            name_printed = True
                                            print(121212)
                                            print(str(all_rows[record][column]).lower())
                                    if EFound:
                                        text = "\n\n\nRow \t" + str(record + 1) + f"\n Column : \t{column}\n\t{str(all_rows[record][column])}"
                                        self.label.insertItem(num, text)
                                        num += 1
                                        printed = True
                                if EFound:
    ...
    def read_file(self):
        ...
        settings_dialog.setGeometry(272, 48, 820, 650)
